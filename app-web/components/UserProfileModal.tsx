      ...
      <DialogContent className="bg-zinc-900 border border-white/10 text-white sm:max-w-[500px]">
        ...
        <div className="flex flex-col items-center justify-center mt-4 mb-6">
          <div className="relative group">
            <Avatar
              key={user.avatarUrl}
              className="h-24 w-24 ring-4 ring-zinc-800"
            >
              <AvatarImage
                src={
                  user.avatarUrl
            ...
            <label
              ...
              className="absolute bottom-0 right-0 p-2 bg-red-600 rounded-full cursor-pointer hover:bg-red-700 transition-colors shadow-lg"
            >
              {isUploading ? (
