  ...
  return (
    <aside className="w-72 bg-sidebar border-r border-sidebar-border h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-border/60">
        <Link
          href="/settings"
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent/40 transition-colors"
        >
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-destructive/10 transition-colors mt-1"
        >
